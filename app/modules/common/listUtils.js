...
/* @module common/listUtils */

/**
 * @apiDefine Filtered
 *
 * @apiParam {String} [filterBy]  Filter query. Example: `field1:value1,field2:value2,...`
 */
 ...
 * @apiDefine Sorted
 *
 * @apiParam {String} [sortby]  Sort query. Example: `field1:1,field2:-1,...`
 */
 ...
 * @apiDefine Paginated
 *
 * @apiParam {Number} [count=20]  Number of items.
 * @apiParam {Number} [page=0]    Page.
 */
